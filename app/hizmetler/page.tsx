...
const fallbackServices = [
  {
    ...
    icon: "⚡",
    description:
      "10+ yıllık deneyimimizle elektrik pano ve marin pano üretiminde sektörün öncü firması. Sıvaüstü, sıvaaltı, dahili ve marin pano üretimi.",
    sort_order: 1,
    is_active: true,
  },
  {
  ...
  },
  {
    ...
    icon: "🔥",
    description:
      "Yüksek kaliteli metal kaynak ve imalat hizmetleri ile güvenilir çözümler. TIG, MIG/MAG kaynak yöntemleri.",
    sort_order: 4,
    is_active: true,
  },
  {
...
export default async function HizmetlerPage() {
  ...
  // Eğer Vercel build ortamındaysa veya veritabanı bağlantısı yoksa fallback kullan
  let services: Awaited<ReturnType<typeof getServices>> = [];

  if (process.env.VERCEL === "1") {
    // Vercel build'de DB_HOST 'SET' ise veya gerçek bir host değilse fallback kullan
    ...
    if (
      ...
      console.warn(
        "⚠️ Vercel build: Veritabanı bağlantısı atlanıyor, fallback hizmetler kullanılıyor",
      );
      services = [];
    } else {
      // Gerçek host varsa dene, ama timeout süresini kısa tut
      try {
        services = await Promise.race([
          ...
          new Promise<typeof services>((resolve) => {
            setTimeout(() => {
              console.warn(
                "⚠️ Vercel build: Veritabanı bağlantı timeout'u - fallback kullanılıyor",
              );
              resolve([]);
    ...
    // Local development'ta normal şekilde çalış
            ...
            <div className="max-w-5xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed mb-8">
                ...
                <span className="block mt-2 text-white font-semibold">
                  CNC lazer kesimden elektrik pano üretimine kadar geniş hizmet
                  yelpazemiz.
                </span>
              </p>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 max-w-2xl mx-auto">
                Endüstriyel üretimden özel tasarıma kadar geniş hizmet
                yelpazemizle yanınızdayız
              </p>
            </div>
              ...
              {displayServices.map((service, index) => {
                ...
                return (
                  ...
                  >
                    {/* Görsel Container */}
                    <div
                      className={`relative overflow-hidden ${isFeatured ? "h-64" : "h-56"}`}
                    >
                      {/* Gradient Overlay */}
                    ...
                    <div className="p-6 md:p-8 flex-grow flex flex-col">
                      <p className="text-slate-600 text-base leading-relaxed mb-6 flex-grow line-clamp-3">
                        {service.description ||
                          `${service.name} hizmetlerimiz hakkında detaylı bilgi almak için tıklayın.`}
                      </p>
                ...
                {[
                  {
                    ...
                    description:
                      "10+ yıllık deneyimimizle en yüksek kalite standartlarında üretim",
                  },
                  {
                    icon: "⚡",
                    title: "Hızlı Teslimat",
                    description:
                      "Zamanında ve hızlı teslimat garantisi ile projelerinizi aksatmıyoruz",
                  },
                  {
                    icon: "🎯",
                    title: "Uzman Ekip",
                    description:
                      "Alanında uzman mühendis ve teknik ekibimizle profesyonel hizmet",
                  },
                  {
                    icon: "💼",
                    title: "Geniş Hizmet Yelpazesi",
                    description:
                      "Tek çatı altında tüm endüstriyel üretim ihtiyaçlarınızı karşılıyoruz",
                  },
                ].map((feature, index) => (
                  <div
                    key={index}
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto leading-relaxed">
                ...
                sunuyoruz. Hemen iletişime geçin ve kaliteli hizmetimizden
                yararlanın!
              </p>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="prose prose-lg prose-slate max-w-none">
                ...
                <div className="space-y-6 text-slate-700 leading-relaxed">
                  <p className="text-lg">
                    Metod Mühendislik olarak, 10+ yıllık deneyimimizle
                    endüstriyel üretim sektöründe öncü bir firma olarak hizmet
                    vermekteyiz. İstanbul merkezli olarak Türkiye genelinde
                    hizmet veren firmamız, CNC lazer kesim, CNC büküm, metal
                    kaynak, elektrostatik toz boya, mağaza raf sistemleri, çelik
                    konstrüksiyon ve elektrik pano üretimi alanlarında
                    profesyonel çözümler sunmaktadır.
                  </p>
                  <p className="text-lg">
                    Müşteri memnuniyeti ve kalite odaklı hizmet anlayışımızla,
                    her projede en yüksek standartları hedefliyoruz. Uzman
                    ekibimiz ve modern teknolojik altyapımızla, endüstriyel
                    üretim ihtiyaçlarınıza en uygun çözümleri sunuyoruz.
                  </p>
                  <p className="text-lg">
                    Tüm hizmetlerimizde ISO kalite standartlarına uygun üretim
                    yapıyor, zamanında teslimat garantisi veriyoruz. Detaylı
                    bilgi ve teklif almak için bizimle iletişime geçebilirsiniz.
                  </p>
                </div>
              </div>
            </div>
