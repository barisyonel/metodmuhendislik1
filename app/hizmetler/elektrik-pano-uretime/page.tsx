            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mb-12 rounded-2xl overflow-hidden shadow-2xl">
                <div className="relative w-full h-[400px] md:h-[500px]">
                  <Image
                    src="/elektrıkpano.png"
                    alt="Elektrik Pano Üretimi - Metod Mühendislik Fabrika Görseli"
                    fill
              ...
              <div className="mt-12 bg-slate-50 rounded-2xl p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex justify-between items-center border-b border-slate-200 pb-4">
                    ...
                    <span className="text-blue-600 font-semibold text-lg">Sıvaüstü, Sıvaaltı, Dahili</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-slate-200 pb-4">
                    <span className="font-bold text-slate-900 uppercase text-sm tracking-wider">
                      Standartlar
                    </span>
                    <span className="text-blue-600 font-semibold text-lg">Uluslararası Elektrik Standartları</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-slate-200 pb-4">
                    <span className="font-bold text-slate-900 uppercase text-sm tracking-wider">
                      Kalite Kontrol
                    </span>
                    <span className="text-blue-600 font-semibold text-lg">Elektriksel Testler</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-slate-200 pb-4">
                    <span className="font-bold text-slate-900 uppercase text-sm tracking-wider">
                      Güvenlik
                    </span>
                    <span className="text-blue-600 font-semibold text-lg">Sertifikalı Üretim</span>
                  </div>
                </div>
              </div>
            </div>
