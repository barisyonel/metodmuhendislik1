...
export const metadata: Metadata = {
  title: "Kaynak & İmalat | Metod Mühendislik",
  description:
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mb-12">
                <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-6">
                  Metal Kaynak ve İmalat Hizmetlerinde Uzmanlık
                </h2>
              ...
              <div className="mb-12">
                <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-6">
                  Metal Kaynak Yöntemlerimiz ve Uygulamalar
                </h2>
                <p className="text-slate-700 text-lg leading-relaxed mb-6">
              ...
              <div className="mt-12 bg-slate-50 rounded-2xl p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex justify-between items-center border-b border-slate-200 pb-4">
                    ...
                    <span className="text-blue-600 font-semibold text-lg">TIG, MIG/MAG, Elektrot</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-slate-200 pb-4">
                    <span className="font-bold text-slate-900 uppercase text-sm tracking-wider">
                      Malzeme Tipleri
                  ...
                  <div className="flex justify-between items-center border-b border-slate-200 pb-4">
                    ...
                    <span className="text-blue-600 font-semibold text-lg">Uluslararası Standartlar</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-slate-200 pb-4">
                    <span className="font-bold text-slate-900 uppercase text-sm tracking-wider">
                      Uygulama Alanları
                    </span>
                    <span className="text-blue-600 font-semibold text-lg">Konstrüksiyon, Makine, Tank</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 md:py-32 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
          <div className="container mx-auto px-6 text-center">
            <h2 className="text-4xl md:text-5xl font-black mb-6 tracking-tight">
              Kaynak & İmalat HİZMETİ İÇİN TEKLİF ALIN
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="https://wa.me/905425786060?text=Merhaba,%20Kaynak%20ve%20İmalat%20hizmeti%20için%20teklif%20almak%20istiyorum."
                target="_blank"
