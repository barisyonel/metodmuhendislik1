...
import { otherMarmaraCities, otherMarmaraCityNames } from "@/lib/blog-data";

export const metadata: Metadata = {
  title: "Diğer Marmara İlleri Blog | Elektrik Pano ve Kaynak Hizmetleri",
  description:
    "Bursa, Balıkesir, Sakarya, Tekirdağ, Yalova ve diğer Marmara illeri için elektrik pano üretimi, kaynak hizmetleri ve endüstriyel üretim çözümleri.",
  keywords:
    "Bursa elektrik pano, Balıkesir kaynak, Sakarya endüstriyel üretim, Tekirdağ elektrik pano, Yalova kaynak hizmetleri",
};

export default function DigerMarmaraBlogPage() {
  return (
    <>
      <Header />
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6">
                Diğer Marmara İlleri Blog
              </h1>
              <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed">
                Bursa, Balıkesir, Sakarya, Tekirdağ, Yalova ve diğer Marmara illeri için elektrik pano ve kaynak hizmetleri
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {otherMarmaraCities.map((city) => {
                const cityName = otherMarmaraCityNames[city] || city;
                return (
                  <div key={city} className="space-y-2">
                    <Link
                      href={`/blog/${city}-elektrik-pano`}
                    ...
                    >
                      <h3 className="font-bold text-slate-900 group-hover:text-blue-600 transition-colors text-sm">
                        {cityName} - Elektrik Pano
                      </h3>
                    </Link>
                    <Link
                      href={`/blog/${city}-kaynak`}
