...
import { gebzeKocaeliDistricts, gebzeKocaeliDistrictNames } from "@/lib/blog-data";

export const metadata: Metadata = {
  title: "Gebze & Kocaeli Blog | Elektrik Pano ve Kaynak Hizmetleri",
  description:
    "Gebze, İzmit ve Kocaeli bölgesi için elektrik pano üretimi, kaynak hizmetleri ve endüstriyel üretim çözümleri. Gebze'de profesyonel hizmet.",
  keywords:
    "Gebze elektrik pano, Gebze kaynak hizmetleri, Kocaeli endüstriyel üretim, İzmit elektrik pano, Darıca kaynak",
};

export default function GebzeKocaeliBlogPage() {
  return (
    <>
      <Header />
      <main className="bg-white min-h-screen pt-24 md:pt-28">
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed">
                Gebze, İzmit ve Kocaeli bölgesi için elektrik pano üretimi, kaynak hizmetleri ve endüstriyel üretim çözümleri
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="container mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-12 text-center">
              Gebze & Kocaeli İlçeleri
            </h2>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {gebzeKocaeliDistricts.map((district) => {
                const districtName = gebzeKocaeliDistrictNames[district] || district;
                return (
        ...
        <section className="py-16 md:py-24 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
          <div className="container mx-auto px-6 text-center">
            ...
            <a
              href="https://wa.me/905425786060?text=Merhaba,%20Gebze%20için%20teklif%20almak%20istiyorum."
              target="_blank"
